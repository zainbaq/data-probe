...
-- Customers table (with some intentional data quality issues for the profiler to find)
...
-- Order line items (FK to orders and products)
...
INSERT INTO customers (first_name, last_name, email, phone, city, country, signup_date, loyalty_tier, annual_spend) VALUES
...
INSERT INTO products (sku, name, category, price, stock_qty, supplier_id) VALUES
...
-- Intentional issues: NULL price, zero stock
...
-- Order with NULL customer (orphan-ish reference)
